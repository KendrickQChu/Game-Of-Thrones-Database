module.exports = function(){
    ...
    function getFamilies(res, mysql, context, complete){
        mysql.pool.query("SELECT Family_ID as id, Family_Name, Head_Of_Family, Castle FROM Family", function(error, results, fields){
            if(error){
                res.write(JSON.stringify(error));
                res.end();
            }
    ...
    router.post('/', function(req, res){
        ...
        var mysql = req.app.get('mysql');
        var sql = "INSERT INTO Family (Family_Name, Head_Of_Family, Castle) VALUES (?,?,?)";
        var inserts = [req.body.Family_Name, req.body.Head_Of_Family, req.body.Castle];
